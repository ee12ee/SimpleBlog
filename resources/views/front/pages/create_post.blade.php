...
@section('create_post')
    <div class="p-4 border rounded">
        <form action="{{route('home.post.store')}}" method="post" class=" g-3 needs-validation " style="text-align: center" novalidate="" enctype="multipart/form-data">
            @csrf
            <div class="">
            ...
            <div class="">
                ...
                <textarea style="width: 100%" type="text" name="description" class="form-control  @error('description') is-invalid @enderror" id="validationCustom01" placeholder="Enter Post Description" required=""></textarea>
                @error('description')
                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
